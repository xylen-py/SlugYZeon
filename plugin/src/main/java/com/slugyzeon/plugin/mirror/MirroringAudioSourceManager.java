...
public abstract class MirroringAudioSourceManager implements AudioSourceManager, HttpConfigurable {
    ...
    protected MirroringAudioSourceManager(Function<Void, AudioPlayerManager> audioPlayerManager,
