...
import com.slugyzeon.plugin.ExtendedAudioTrack;
...
public abstract class MirroringAudioTrack extends ExtendedAudioTrack {
    ...
    public MirroringAudioTrack(AudioTrackInfo trackInfo, String albumName, String albumUrl, String artistUrl,
    ...
    public void process(LocalAudioTrackExecutor executor) throws Exception {
        ...
        if (track instanceof InternalAudioTrack) {
            ...
            log.debug("Loaded track mirror from {} {}({}) ", internalTrack.getSourceManager().getSourceName(),
