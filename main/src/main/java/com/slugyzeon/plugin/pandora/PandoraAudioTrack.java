...
public class PandoraAudioTrack extends MirroringAudioTrack {
    ...
    public PandoraAudioTrack(AudioTrackInfo trackInfo, PandoraAudioSourceManager sourceManager) {
        this(trackInfo, null, null, null, null, null, false, sourceManager);
    }

    public PandoraAudioTrack(AudioTrackInfo trackInfo, String albumName, String albumUrl, String artistUrl,
