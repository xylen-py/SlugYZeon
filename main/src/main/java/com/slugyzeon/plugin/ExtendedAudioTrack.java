...
public abstract class ExtendedAudioTrack extends DelegatedAudioTrack {
    ...
    public ExtendedAudioTrack(AudioTrackInfo trackInfo, String albumName, String albumUrl, String artistUrl,
            String artistArtworkUrl, String previewUrl, boolean isPreview) {
        super(trackInfo);
